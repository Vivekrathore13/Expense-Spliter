...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        // ✅ if invite token exists -> directly join group
        if (inviteToken) {
        ...
        <div className="w-full max-w-5xl rounded-[32px] overflow-hidden shadow-2xl border border-blue-100 bg-white/80 backdrop-blur-md grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-10 md:p-14 flex flex-col justify-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight">
              Create your <br />
              <span className="text-blue-600">Expense Splitter</span> account
            </h1>

            <p className="text-gray-600 mt-5 text-lg leading-relaxed">
              Start splitting expenses with friends and family. Track who owes
              what & settle up instantly.
            </p>
            ...
            <div className="mt-8 space-y-3 text-gray-600 text-sm">
              ...
              {inviteToken && <p className="text-blue-700 font-semibold">✅ Invite detected — you will join group after signup</p>}
            </div>
            ...
            <p className="text-sm text-gray-500 mt-10">
              ...
              <span
                onClick={() => {
                  if (inviteToken) navigate(`/login?token=${inviteToken}`);
                  else navigate("/login");
                }}
